...
import 'package:nus_spots/browse_page.dart';
import 'globals.dart';
...
class _CustomState extends State<Custom> {
  ...
  addLocation() {
    var randomDoc = locationsRef.doc();
              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.numberWithOptions(),
                    ...
                    onChanged: (value) => currLat = double.parse(value),
                    decoration: new InputDecoration(
                        hintText: 'Enter intended Latitude value'
                    )
                ),
                SizedBox(height: 20.0),
                TextFormField(
                    ...
                    onChanged: (value) => currLong = double.parse(value),
                    decoration: new InputDecoration(
                        hintText: 'Enter intended Longitude value'
                    )
                ),
                SizedBox(height: 20.0),
                RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      print(currentTags);
                      print(imgURL);
                      print(currLat.toString());
                      print(currLong.toString());
                    }
                ),
